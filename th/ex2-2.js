...
Answer: ง่ายขึ้นครับ เพราะ ทำให้สามารถเห็น action ได้ง่ายหากจะต้องการเปลี่ยนก็สามารถทำได้ง่ายเพราะยังไงชื่อ callback function ก้เป็น action ที่ทำอยู่แล้ว
...
Answer:  callback function คือ function ที่เราเขียนขึ้นมาเพื่อนำมาเรียกใช้ซ้ำ
         ...
         จะเห็นได้ว่าเราแค่เรียกใช้ตัว callback function โดยไม่ต้องเขียนซ้ำ ซึ่งตัว Higher-Order Function จะเป็นตัวไปดึงมาว่าจะใช้ callbackfunction ไหน โดยผ่านคำสั่งที่เรียกใช้ Higher-Order Function ว่า กำหนด Argrument เป็นอะไร
